...
var app = angular.module('app',[ 'satellizer','ngRoute', 'ngResource', 'ui.router','ui.validate', 'app.login', 'app.logout', 'app.navbar', 'app.usuario', 'app.contatos', 'app.usuario', 'app.email','angular-loading-bar', 'ui.bootstrap', 'ngFileUpload'])
